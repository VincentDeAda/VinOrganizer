...
internal class OrgCommand
{
	...
	{
		var res = _db.Organize(paramSet.Path, paramSet.RecursionDepth, paramSet.Steal, paramSet.Recursive, paramSet.MoveUncategorized, paramSet.AutoRename, paramSet.NoLog, paramSet.SilentMode);
		if (res is null)
